/*Для каждой таблицы схемы вывести: 1) имя таблицы; 2) имя первого столбца первого (по алфавиту) ограничения уникальности; 
3) имя второго столбца первого ограничения уникальности; 4) общее число столбцов в первом ограничении уникальности; 
5) имя первого столбца второго (по алфавиту) ограничения уникальности; 6) имя второго столбца второго ограничения уникальности; 
7) общее число столбцов во втором ограничении уникальности; 8) общее число ограничений уникальности.*/
